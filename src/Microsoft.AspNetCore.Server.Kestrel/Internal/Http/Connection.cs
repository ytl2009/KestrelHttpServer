    ...
    public class Connection : ConnectionContext, IConnectionControl
    {
        ...
        public virtual void OnSocketClosed()
        {
            _frame.FrameStartedTask.ContinueWith((task, state) =>
            {
                ...
                if (connection._filteredStreamAdapter != null)
                {
        ...
        private async Task ApplyConnectionAdaptersAsync()
        {
            try
            {
                ...
                if (adapterContext.ConnectionStream != rawStream)
                {
                    ...
                    _filteredStreamAdapter = new AdaptedPipeline(ConnectionId, adapterContext.ConnectionStream,
                ...
                _frame.PrepareRequest = features =>
                {
                    try
                    {
                        ...
                        {
                            adaptedConnection.PrepareRequest(features);
                        }
                    }
                    catch (Exception ex)
                    {
